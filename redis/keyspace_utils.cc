...
future<> create_keyspace_if_not_exists_impl(lw_shared_ptr<db::config> config, int default_replication_factor) {
...
future<> create_keyspace_if_not_exists(lw_shared_ptr<db::config> config) {

...
deps = {
    ...
    'apps/redis/redis': [
      ...
      'apps/redis/list.cc',
      'apps/redis/main.cc',
      'apps/redis/redis_commands.cc',
      'apps/redis/db.cc',
      'apps/redis/system_stats.cc',
      'apps/redis/redis_protocol_parser.rl',
      'apps/redis/redis_protocol.cc',
      ] + libnet + core,
...
with open(buildfile, 'w') as f:
    ...
    f.write(textwrap.dedent('''\
        ...
        cxxflags = -std=gnu++1y {dbgflag} {fpie} -Wall -fpermissive -fvisibility=hidden -pthread -I. -U_FORTIFY_SOURCE {user_cflags} {warnings} {defines}

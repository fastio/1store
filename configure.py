...
with open(buildfile, 'w') as f:
    ...
    f.write(textwrap.dedent('''\
        ...
        rule serializer
            command = /usr/local/bin/python3 ./idl-compiler.py --ns ser -f $in -o $out
    ...
    for mode in build_modes:
        ...
        f.write(textwrap.dedent('''\
            cxxflags_{mode} = {sanitize} {opt} -I $builddir/{mode}/gen  -I$builddir/{mode}/gen/seastar -I$builddir/{mode}/gen/seastar/seastar -I $builddir/{mode}/seastar/c-ares -I. -I./utils -I./seastar -I./seastar/fmt

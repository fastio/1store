...
/*
    ...
    void register_redis_internal_data_bus(std::function<future<redis::result>(std::function< future<redis::result> (const rpc::client_info&, redis::request_wrapper&&)> && func)>);
    void unregister_redis_internal_data_bus();
    future<redis::result> redis_internal_data_bus(msg_addr id, redis::request_wrapper&& req);
*/

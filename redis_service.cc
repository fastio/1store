...
distributed<redis_service> _the_redis_srvice;

future<> redis_service::set(const dht::decorated_key& dk, const sstring& value, output_stream<char>& out)
{
...
future<> redis_service::del(const dht::decorated_key& dk, output_stream<char>& out)
{
    return make_ready_future<>();
/*
    auto cpu = get_cpu(dk);
...
future<> redis_service::get(const dht::decorated_key& dk, output_stream<char>& out)
{
    return make_ready_future<>();
/*
    auto cpu = get_cpu(dk);
